...
class LIFT_WP {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      LIFT_WP_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - LIFT_WP_Loader. Orchestrates the hooks of the plugin.
	 * - LIFT_WP_i18n. Defines internationalization functionality.
	 * - LIFT_WP_Admin. Defines all hooks for the admin area.
	 * - LIFT_WP_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		$this->loader = new LIFT_WP_Loader();
	 ...
	 *
	 * Uses the LIFT_WP_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new LIFT_WP_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new LIFT_WP_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    LIFT_WP_Loader    Orchestrates the hooks of the plugin.
	 */
